...
use App\Catalog\Application\ListPurchasableMovies\ListPurchasableMovies;
use App\Catalog\Infrastructure\Entrypoint\Http\Requests\MovieCatalogFilterRequest;
use Illuminate\Http\JsonResponse;

class ListPurchasableMoviesController
{
    public function __construct(
        private ListPurchasableMovies $listPurchasableMovies,
    ) {}
    ...
    public function __invoke(MovieCatalogFilterRequest $request): JsonResponse
    {
        ...
        $response = ($this->listPurchasableMovies)(
