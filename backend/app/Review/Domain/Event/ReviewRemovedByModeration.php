...
class ReviewRemovedByModeration
{
    ...
    public static function create(Uuid $reviewId, Uuid $reviewAuthorId, Uuid $movieId, ?string $reviewBody): self
    {
        return new self($reviewId, $reviewAuthorId, $movieId, $reviewBody);
    }
