...
class ReleaseReservedStockTest extends TestCase
{
    ...
    public function test_releases_reserved_stock_back_to_available(): void
    {
        ...
        (new ReleaseReservedStock($repository, $this->transactionRunner()))($copy->id()->value(), 2);
    ...
    public function test_throws_when_copy_not_found(): void
    {
        ...
        (new ReleaseReservedStock($repository, $this->transactionRunner()))(Uuid::generate()->value(), 1);
    }
